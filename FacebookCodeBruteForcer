...
// Funkcja opóźniająca wykonanie programu (np. 5 sekund)
const initialDelay = async () => {
    console.log('Początek programu...');
    await new Promise(resolve => setTimeout(resolve, 5000)); // Opóźnienie przez 5 sekund
    console.log('Koniec opóźnienia, kontynuacja działania programu.');
};
